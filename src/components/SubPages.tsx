...
interface SubPagesProps {
  initialPage: 'blog' | 'help' | 'privacy' | 'terms';
  onNavigate: (page: 'home' | 'blog' | 'help' | 'privacy' | 'terms') => void;
  darkMode: boolean;
}

export default function SubPages({ initialPage, onNavigate, darkMode }: SubPagesProps) {
  const [activeTab, setActiveTab] = useState<'blog' | 'help' | 'privacy' | 'terms'>(initialPage);
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              ...
              <p className="mt-2 text-xs text-slate-400 max-w-xl">
                ...
                {activeTab === 'privacy' && 'Compliant customer storage, patient records safety policies, and payment token structures.'}
                {activeTab === 'terms' && 'Clear online service booking agreements, cancellations cooling policies, and service guidelines.'}
              </p>
            </div>

            {/* Quick mini switcher */}
            <div className="flex flex-wrap gap-1 bg-slate-800/60 p-1.5 rounded-xl border border-slate-700/50 shrink-0">
              <button 
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          >
            <div className="md:col-span-4">
              <div className="sticky top-20 space-y-4">
                ...
                <div className="p-4 bg-orange-500/5 text-orange-600 border border-orange-500/10 rounded-xl text-left">
                  <h5 className="text-[10px] font-black uppercase tracking-wider">Disclaimer</h5>
                  <p className="text-[10px] mt-1 text-slate-500 leading-normal">
                    User scheduling data, including names and phone coordinates, is stored only to complete scheduling validations. No user list is ever leased, sold, or shared.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-8 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-slate-150 dark:border-slate-800 space-y-6 text-xs text-slate-600 dark:text-slate-350 leading-relaxed font-sans">
              <h3 className="text-base font-extrabold text-slate-900 dark:text-white uppercase tracking-wider border-b border-slate-100 dark:border-slate-800 pb-3">Online Service Booking Privacy Policy</h3>
              <p className="text-[10px] text-slate-400">Last updated: May 31, 2026</p>
              
              <section className="space-y-2">
                <h4 className="text-xs font-black text-slate-900 dark:text-white uppercase">1. Collected Coordinates & Onboarding Data</h4>
                <p>
                  When you utilize AppointO Technologies (presented by Innovatronix IT Solutions LLP) to book and manage appointments, we collect the necessary validation parameters. This includes customer names, contact phone numbers (essential for automated WhatsApp status text delivery), business profiles, selected hours/slots, and pre-payment references.
                </p>
              </section>

              <section className="space-y-2">
                <h4 className="text-xs font-black text-slate-900 dark:text-white uppercase">2. Automated Reminders and WhatsApp Policy</h4>
                <p>
                  As an official Meta Cloud integration platform, AppointO issues alerts regarding active confirmations, waiting coordinates, and schedule changes. By registering your clinic/salon parameters, you warrant that you invite customer-initiated scheduling threads and provide an optimized Opt-Out mechanism inside every reminder.
                </p>
              </section>

              <section className="space-y-2">
                <h4 className="text-xs font-black text-slate-900 dark:text-white uppercase">3. Banking & Transaction Security</h4>
                <p>
                  AppointO integrates directly with standard payment processing aggregators. We never collect or cache credit credentials, internal CVV nodes, or personal UPI PIN coordinates on our cloud systems. All transactions utilize SSL/TLS secure pathways provided securely by payment processors.
                </p>
              </section>

              <section className="space-y-2">
                <h4 className="text-xs font-black text-slate-900 dark:text-white uppercase">4. Deletion & Data Retention Rights</h4>
                <p>
        ...
        {activeTab === 'terms' && (
          ...
          >
            <div className="md:col-span-4">
              <div className="sticky top-20 bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-150 dark:border-slate-800 space-y-4">
                ...
                <p className="text-[11px] text-slate-500">
                  By executing booking services via AppointO, you subscribe completely to the standard terms administered by Innovatronix IT Solutions LLP.
                </p>
            ...
            <div className="md:col-span-8 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl border border-slate-150 dark:border-slate-800 space-y-6 text-xs text-slate-600 dark:text-slate-350 leading-relaxed font-sans">
              <h3 className="text-base font-extrabold text-slate-900 dark:text-white uppercase tracking-wider border-b border-slate-100 dark:border-slate-800 pb-3">Platform Terms & Conditions</h3>
              <p className="text-[10px] text-slate-400">Last updated: May 31, 2026</p>
              ...
              <section className="space-y-2">
                <h4 className="text-xs font-black text-slate-900 dark:text-white uppercase">1. Trial Use and Registration Limits</h4>
                <p>
              ...
              <section className="space-y-2">
                <h4 className="text-xs font-black text-slate-900 dark:text-white uppercase">2. Refund Rules and Customer Cancellations</h4>
                <p>
                  Cancellations initiated through AppointO widgets are authorized and delivered to your respective business parameters. Businesses are legally liable for configuring correct cancellation windows and initiating prompt payouts or credit options through our integrations where appropriate.
                </p>
              </section>

              <section className="space-y-2">
                <h4 className="text-xs font-black text-slate-900 dark:text-white uppercase">3. Acceptable Use Policy</h4>
                <p>
              ...
              <section className="space-y-2">
                <h4 className="text-xs font-black text-slate-900 dark:text-white uppercase">4. Legal Jurisdiction & Office Operations</h4>
                <p>
                  ...
                  <strong className="text-slate-800 dark:text-white block mt-1.5 font-bold">
                    Innovatronix IT Solutions LLP, N3-IRC Village, Nayapali, Bhubaneswar, Odisha-751015
                  </strong>
                </p>
              </section>
            </div>
